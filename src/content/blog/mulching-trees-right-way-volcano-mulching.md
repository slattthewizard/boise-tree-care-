---
title: "Mulching Trees the Right Way (Stop Volcano Mulching)"
navTitle: "Mulching Trees the Right Way"
metaTitle: "How to Mulch Around Trees (Stop Volcano Mulching)"
metaDescription: "Learn how to mulch around trees the right way. Boise arborists explain why volcano mulching kills trees and show proper technique. Free estimates."
primaryKeyword: "how to mulch around trees"
secondaryKeywords: "volcano mulching bad, proper tree mulching, mulch around trees boise, tree mulching mistakes"
publishedDate: "2026-04-07"
tag: "Tree Care"
subtitle: "Drive through any neighborhood in Boise and count the mulch volcanoes. Those big mounds of bark and wood chips piled a foot high against tree trunks."
canonical: "https://boisetreepro.com/blog/mulching-trees-right-way-volcano-mulching/"
faq:
  - question: "Can too much mulch kill a tree?"
    answer: "Yes. Excessive mulch (six inches or more piled against the trunk) causes bark rot, root girdling, and pest problems that can kill a tree over several years. Stick to two to four inches, away from the trunk."
  - question: "Is it OK to put mulch over tree roots that are showing above ground?"
    answer: "A thin layer (two inches) is fine and can help protect exposed roots. But don't bury them deeply. Surface roots are there because the tree needs them near the surface for oxygen exchange. Heavy mulching over exposed roots can suffocate them."
  - question: "How far from the trunk should mulch be?"
    answer: "Keep mulch at least three to four inches away from the trunk. You should always be able to see the root flare where the trunk widens at the base."
  - question: "Should I use landscape fabric under mulch around trees?"
    answer: "No. Landscape fabric blocks water infiltration, prevents organic matter from reaching the soil, and restricts root growth. Skip it around trees entirely."
  - question: "What about rubber mulch?"
    answer: "Don't use it around trees. Rubber mulch doesn't decompose, doesn't improve soil, retains excessive heat, and can leach chemicals. It's occasionally used in playgrounds, but it has no place in tree care."
---
Drive through any neighborhood in Boise and count the mulch volcanoes. Those big mounds of bark and wood chips piled a foot high against tree trunks. You'll lose count before you finish a single block.
...
|---|---|---|
| Depth | 2-4 inches | 6+ inches |
| Distance from trunk | 3-4 inches away | Touching trunk |
| Shape | Flat donut | Volcano/mound |
| Coverage | Out toward drip line | Small ring only |
| Refresh | When below 2 inches | Every season on top |
...
Yes. Excessive mulch (six inches or more piled against the trunk) causes bark rot, root girdling, and pest problems that can kill a tree over several years. Stick to two to four inches, away from the trunk.

**Is it OK to put mulch over tree roots that are showing above ground?**
A thin layer (two inches) is fine and can help protect exposed roots. But don't bury them deeply. Surface roots are there because the tree needs them near the surface for oxygen exchange. Heavy mulching over exposed roots can suffocate them.

**How far from the trunk should mulch be?**
Keep mulch at least three to four inches away from the trunk. You should always be able to see the root flare where the trunk widens at the base.

**Should I use landscape fabric under mulch around trees?**
No. Landscape fabric blocks water infiltration, prevents organic matter from reaching the soil, and restricts root growth. Skip it around trees entirely.

**What about rubber mulch?**
Don't use it around trees. Rubber mulch doesn't decompose, doesn't improve soil, retains excessive heat, and can leach chemicals. It's occasionally used in playgrounds, but it has no place in tree care.
