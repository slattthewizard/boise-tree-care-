---
title: "Neighbor's Tree Hanging Over My Yard: Can I Trim My Neighbor's Tree Branches in Idaho?"
navTitle: "Neighbor's Tree Hanging Over"
metaTitle: "Can I Trim Neighbor's Tree Branches in Idaho? (2026)"
metaDescription: "Can I trim my neighbor's tree branches in Idaho? Learn your legal trimming rights, what the law allows, and when to call a Boise arborist. Free estimates."
primaryKeyword: "can I trim neighbor's tree branches idaho"
secondaryKeywords: "neighbor tree overhanging my property idaho, tree branch encroachment idaho, neighbor tree dispute boise, trimming neighbor's tree Idaho law"
publishedDate: "2026-04-08"
tag: "Tree Care"
subtitle: "That big silver maple next door looked harmless enough when you moved in. Now its branches are draped six feet over your fence, dropping leaves into your gutters every fall and shading out the garden..."
canonical: "https://boisetreepro.com/blog/neighbor-tree-trimming-rights-idaho/"
faq:
  - question: "Can I trim my neighbor's tree branches that hang over my yard in Idaho?"
    answer: "Yes. Under Idaho common law, you have the legal right to trim branches that cross your property line, back to the property line. You cannot cross onto your neighbor's property, and your trimming must not kill or seriously damage the tree. If the branches are large or the situation is contentious, consult an ISA-certified arborist before cutting."
  - question: "Who pays for trimming a neighbor's tree hanging over my property in Idaho?"
    answer: "Generally, you do. The cost falls on you under Idaho's self-help doctrine. The exception: if the tree is hazardous and the neighbor has been notified but refuses to act, they may be liable for abatement costs and resulting damage."
  - question: "Can I throw the cut branches back over the fence?"
    answer: "Technically, cut branches belong to the tree owner. In practice, tossing them over the fence escalates conflict. Dispose of them yourself or offer to let your neighbor know you'll handle disposal."
  - question: "What if trimming the overhanging branches would kill the tree?"
    answer: "You need professional guidance. If addressing the encroachment would seriously harm the tree, you cannot simply proceed. An arborist can recommend an approach that works without fatal damage, or document that the tree's condition makes it a hazard requiring removal."
  - question: "Can my neighbor sue me for trimming branches on my side?"
    answer: "They can file a claim, but they're unlikely to win if you stayed on your side, trimmed only to the property line, and didn't damage the tree. The risk goes up if you made improper cuts, removed too much canopy, or crossed the line. Professional documentation is your best legal protection."
---
...
Idaho courts have consistently upheld this principle, and it's supported by [Idaho property law under Title 55](https://legislature.idaho.gov/statutesrules/idstat/Title55/).
...
- **Follow proper pruning standards.** Hacking branches with a chainsaw isn't pruning. Cuts should follow [ANSI A300 pruning standards](https://www.treesaregood.org/) and ISA best practices. Bad cuts create decay points that can kill a tree slowly.
...
If those overhanging branches are already causing problems, our [professional tree trimming](/tree-trimming-boise/) team can handle the pruning safely and correctly, with proper documentation. **Call (509) 351-8404** for a free assessment.
...
1. **Start with the problem, not the solution.** "Hey, the branches from your elm are dropping a lot of debris on our patio. Can we figure something out?" works better than "I'm going to cut your tree back."
2. **Offer to split the cost.** Many neighbor tree disputes dissolve the moment someone suggests sharing the expense. A $400 to $800 professional pruning job split two ways is cheaper than a lawyer.
3. **Put the agreement in writing.** Even a simple email counts. "Just confirming we agreed I'd have the overhanging branches pruned back to the fence line, and we'll split the cost."
4. **If they refuse, document everything.** Dated photos, written letter (not just a text), copies of everything. This paper trail shows you acted reasonably.

### When Talking Won't Work

Sometimes a neighbor is unresponsive, hostile, or absent (rental properties are common in the Treasure Valley). In those cases: document with photos and dates, send a certified letter, hire an [ISA-certified arborist](/#about) (not a handyman), and keep all receipts.
...
> **The safest move when you're unsure:** Get a professional assessment before cutting anything. [Contact us](/#contact) and we'll tell you exactly what you're dealing with, free of charge.
...
If you hire someone to prune a neighbor's overhanging tree and they damage it, **you're liable.** Not the person you hired. You authorized the work. That's why hiring an ISA-certified arborist matters. They carry insurance, follow [industry pruning standards](https://www.treesaregood.org/), and know the difference between proper crown reduction and butchering that kills trees. The [University of Idaho Extension](https://www.uidaho.edu/extension/forestry) also offers resources on proper tree care for Idaho species.

For work that requires professional equipment, [our tree care services](/#services) follow ANSI A300 standards on every job.
...
1. **Talk to your neighbor first.** A five-minute conversation can save months of tension.
2. **Document everything.** Photos, dates, written correspondence. This matters if things escalate.
3. **Know the property line.** If there's any doubt, get a survey.
4. **Hire a certified arborist for anything beyond basic hand-pruning.** The cost of professional tree care is a fraction of what you'll pay if improper pruning damages the tree.
5. **Keep it legal.** Trim to the property line, make proper cuts, don't trespass, and don't poison anything.
...
**Call (509) 351-8404 or [schedule your free estimate](/#contact) today.**
