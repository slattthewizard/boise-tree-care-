---
title: "Landlord or Tenant: Who Pays for Tree Work at an Idaho Rental?"
navTitle: "Landlord or Tenant: Who Pays"
metaTitle: "Landlord or Tenant: Who Pays for Tree Work at an Idaho Rental?"
metaDescription: "A storm limb just cracked over your rental's carport in Nampa. Here's who is actually on the hook under Idaho law, landlord or tenant, and what the fix typically costs."
primaryKeyword: "landlord tenant tree responsibility idaho"
secondaryKeywords: "who pays tree removal rental property idaho, rental property tree maintenance responsibility, landlord tree removal duty idaho, tenant tree damage liability, idaho rental property tree law"
publishedDate: "2026-08-05"
tag: "Tree Care"
subtitle: "Landlord tenant tree responsibility in Idaho comes down to one test: who owns the tree, not who happens to mow the lawn."
canonical: "https://boisetreepro.com/blog/landlord-tenant-tree-responsibility-idaho/"
faq:
  - question: "Can a landlord force a tenant to pay for tree removal in Idaho?"
    answer: "Only if the lease specifically assigns that cost or the damage is documented as tenant-caused, like equipment damage to the trunk. A tree that dies of age, disease, or storm damage stays the landlord's expense under Idaho's ownership rules, regardless of what a generic \"tenant maintains yard\" clause says."
  - question: "Is a landlord required to trim trees at a rental property?"
    answer: "Idaho Code § 6-320 doesn't name trees directly, but a hazard limb or a leaning tree that threatens the structure falls under the \"hazardous to health or safety\" language, which can force a landlord's hand. Routine, non-hazard trimming is a lease-term question rather than a statutory one."
  - question: "What happens if a tree falls on a tenant's parked car?"
    answer: "That claim goes through the tenant's own auto insurance policy, not the landlord's homeowner policy. The landlord's insurance covers the structure and the tree removal itself, but not a tenant's personal vehicle or belongings."
  - question: "Can a tenant remove a hazard tree themselves if the landlord won't act?"
  ...
  - question: "Does a lease need a written tree-maintenance clause?"
    answer: "It's not legally required, but every property manager we work with who has one gets fewer disputes. Spelling out who calls for emergency work, who pays for tenant-caused damage, and who handles routine trimming above ground level heads off almost every argument before it starts."
---
...
**Got a hazard tree at a rental in Ada or Canyon County right now? [Get a same-day assessment](/#contact) before it turns into an insurance claim or a deposit fight.**
...
Outside that narrow habitability list, tree maintenance defaults to whatever the lease actually says. Idaho courts and most property managers treat a mature tree as part of the real property, the same as the roof or the foundation, so absent a specific clause, the job belongs to whoever owns the dirt it's rooted in. The City of Boise's own [renter rights and responsibilities notice](https://www.cityofboise.org/departments/planning-and-development-services/code-compliance/renter-protections/notice-of-tenant-rights-plus-responsibilities/) draws the same general line: structural and hazard conditions sit with the owner.
...
A storm splits a limb onto a carport at 11pm and the tenant is the one calling. Because our [emergency tree service](/emergency-tree-service-boise/) runs a 24/7 line with same-day response, and because a hazard like this sits inside the landlord's habitability duty, the bill goes to the property owner, not the renter.
...
**Limb down or a tree leaning toward your rental in Ada or Canyon County? Call (866) 228-3559, we run 24/7 and can get someone out the same day.**
...
One more wrinkle worth knowing: if the tree in question is a street tree, planted in the parking strip between sidewalk and curb, ownership isn't the landlord's or the tenant's call at all. Our guide on [street trees in Boise and who owns them](/blog/street-trees-boise-who-owns/) covers that, and removal there still runs through the city's [permit process](/blog/tree-removal-permits-boise/), even in an emergency. Boise's street-tree rules don't waive for a rental property.

If the tree sits on a property line shared with a neighboring lot, ownership can be split, and that changes who has a say in removal regardless of what the lease says. Our piece on [neighbor tree trimming rights in Idaho](/blog/neighbor-tree-trimming-rights-idaho/) walks through that scenario.
...
**Call (866) 228-3559** or [request a free estimate online](/#contact).
