---
title: "Topping Trees: Why Every Boise Arborist Tells You Not to Do It"
navTitle: "Topping Trees: Why Every"
metaTitle: "Is Tree Topping Bad? Why Boise Arborists Say Never"
metaDescription: "Is tree topping bad? Yes. Learn why topping causes decay, weak regrowth, and early death, plus what Boise arborists recommend instead. Free estimates."
primaryKeyword: "is tree topping bad"
secondaryKeywords: "why not to top trees, tree topping damage, tree topping vs pruning, tree topping boise"
publishedDate: "2026-04-23"
tag: "Cost Guide"
subtitle: "A homeowner on Boise's Bench called us last fall about a silver maple that had been topped three years earlier by another company. The tree was supposed to be \"under control."
canonical: "https://boisetreepro.com/blog/tree-topping-bad-boise/"
faq:
  - question: "Is tree topping bad for all tree species?"
    answer: "Yes. There is no species that benefits from topping. Some species tolerate it slightly better than others (willows, for example, can regrow aggressively), but the structural damage, decay risk, and weakened attachment of regrowth applies universally. Proper pruning is always the better option."
  - question: "Can a topped tree recover?"
    answer: "It depends on how severely it was topped, how long ago, and the tree's overall health. A tree topped once may recover with corrective pruning over several years by an ISA-certified arborist. A tree that has been topped repeatedly is often too far gone structurally. Our arborists can assess whether restoration is realistic or whether removal is the safer path."
  - question: "My tree is too tall. What should I do instead of topping?"
    answer: "Crown reduction pruning can lower a tree's height by cutting back to appropriately sized lateral branches. This reduces height while preserving structure and appearance. If the tree is genuinely too large for its location and can't be adequately reduced, professional removal and replanting with a species suited to the space may be the best long-term solution."
  - question: "Is topping a tree illegal in Boise?"
    answer: "Topping is not illegal in Boise for trees on private property. However, it violates ANSI A300 industry standards, and the ISA considers it a harmful practice. Some municipalities nationwide have begun restricting topping, but Boise has not enacted specific topping ordinances as of 2026. The fact that it's legal doesn't make it a good idea."
  - question: "How much does proper pruning cost compared to topping?"
    answer: "Proper pruning typically costs more per visit because it takes more time and skill. But over a 10-year period, you'll spend less total because properly pruned trees need work only every three to five years, while topped trees need re-topping every two to three years plus eventual removal. The math favors doing it right the first time."
  - question: "Will my homeowner's insurance cover damage from a topped tree?"
    answer: "If a topped tree fails and damages property, your insurer may argue that the tree was a known hazard, especially if an arborist had previously documented concerns. Maintaining trees to industry standards (ANSI A300) is the best way to protect yourself from both physical and financial risk."
---
...
**Considering topping because your tree feels too large or too close to your house?** [Contact our arborists for a free assessment](/#contact). We'll tell you what your tree actually needs, and it's almost never topping.
...
**[Get your free estimate](/#contact) or call [(208) 247-9766](tel:2082479766).**
