---
title: "Tree Diseases in Boise: What to Watch For"
navTitle: "Tree Diseases in What to Watch"
metaTitle: "Tree Diseases in Boise: What to Watch For (Arborist Guide)"
metaDescription: "Common tree diseases in Boise, Idaho. ISA-certified arborists explain Dutch elm disease, iron chlorosis, fire blight, and what to do about each one."
primaryKeyword: "tree diseases boise"
secondaryKeywords: "tree diseases idaho, sick tree boise, dutch elm disease boise, iron chlorosis boise, tree pest treatment boise"
publishedDate: "2026-04-12"
tag: "Tree Health"
subtitle: "Last spring, a homeowner in the North End called us about an elm that was \"dying on one side.\" The left half of the canopy was green and full."
canonical: "https://boisetreepro.com/blog/tree-diseases-boise/"
faq:
  - question: "Can a diseased tree be saved?"
    answer: "Depends on the disease and how far it's progressed. Dutch elm disease caught in the first branch: often yes. Fire blight limited to branch tips: yes with proper pruning. Iron chlorosis: manageable with treatment. Cytospora on blue spruce: you can slow it, but it doesn't reverse. A dead tree with mushrooms at the base: no. The sooner you call, the better your odds."
  - question: "Are tree diseases contagious to other trees?"
    answer: "Some are. Dutch elm disease spreads between elms via bark beetles. Fire blight spreads through rain splash and contaminated pruning tools. Cytospora can spread to nearby stressed trees. Iron chlorosis is not contagious because it's a soil chemistry issue, not an infection."
  - question: "When should I prune my elm trees in Boise?"
    answer: "November through March only. This is the dormant season when elm bark beetles (the primary vector for Dutch elm disease) are inactive. Pruning during warm months creates fresh wounds that attract beetles carrying the fungus. There are no exceptions to this rule."
  - question: "My blue spruce is losing its lower branches. Is it dying?"
    answer: "Probably cytospora canker, which is extremely common in Boise blue spruces. It starts low and progresses upward over years. There's no cure, but you can slow it by reducing stress (deep watering, mulching, good air circulation). Eventually, many homeowners opt for removal when the tree loses enough canopy to look unsalvageable."
  - question: "Should I remove a tree with mushrooms growing at the base?"
    answer: "Mushrooms at the base of a tree usually indicate root decay or heartwood rot. This is a structural concern, not just a health one. The tree may look fine above ground but be compromised below. Get an arborist assessment. In many cases, removal is the safest option, especially if the tree is near a structure."
  - question: "Is emerald ash borer in Idaho?"
    answer: "Not yet as of early 2026. But it's moving westward and Idaho has been identified as suitable habitat. If you have ash trees, don't move firewood from other states, and watch for D-shaped exit holes in the bark. Preventive treatments exist but aren't recommended until EAB is confirmed in the region. ---"
---
...
**Worried about a tree? [Get a free assessment.](/#contact)**

---

## The Most Common Tree Diseases in Boise
...
**Trees affected.** Red maples, pin oaks, sweetgums, some ornamental maple cultivars. We see this constantly in [Meridian](/tree-service-meridian/) and [Nampa](/tree-service-nampa/) subdivisions where these species were planted without soil testing.
...
- **Severe/chronic cases:** The tree may not be worth saving. If it's been chlorotic for years and is declining structurally, [replacement with an alkaline-tolerant species](/blog/best-trees-to-plant-boise/) is often the better investment
...
**What it is.** A bacterial infection (Erwinia amylovora) that attacks trees in the rose family. It's one of the most common diseases we treat in Boise, especially in areas with fruit tree heritage like [Nampa](/tree-service-nampa/) and [Caldwell](/tree-service-caldwell/).
...
**Trees affected.** Cottonwoods (especially along canals in [Garden City](/tree-service-garden-city/) and Nampa), elms, maples, willows.
...
Several species of bark beetle target stressed trees in the Treasure Valley, particularly ponderosa pines in the foothills around [Eagle](/tree-service-eagle/) and the Boise Front. Drought-stressed trees produce less sap (their primary defense), making them vulnerable to beetle attack.
...
[Emerald ash borer](https://www.aphis.usda.gov/plant-pests-diseases/eab) (EAB) hasn't been confirmed in Idaho yet, but it's getting closer. This invasive beetle has killed hundreds of millions of ash trees across the eastern United States and is moving westward.
...
- Report suspicious signs to the [Idaho State Department of Agriculture](https://agri.idaho.gov/)
...
When in doubt, a [tree health assessment](/blog/tree-health-assessment-boise/) costs $75 to $250 and gives you a definitive answer. It's cheap insurance compared to losing a tree you could have saved.

**[Schedule a free estimate or health assessment.](/#contact)**
...
**Call [(208) 247-9766](tel:2082479766)** or [request a free assessment online](/#contact).
