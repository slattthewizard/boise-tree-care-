...
If your tree is throwing out more suckers than usual this season, it might be worth a [tree health assessment from a certified arborist](https://boisetreepro.com/#contact) to figure out what's going on beneath the surface.
...
For persistent cases, a combination of proper removal technique and addressing the underlying stress is the only path to long-term success. Sometimes that means adjusting your [tree trimming approach](https://boisetreepro.com/services/tree-trimming-boise/) or dealing with a root system issue.
...
**With grafted trees, always remove suckers originating below the graft union.** Tear them off when small, cut flush when large. Check monthly during the growing season. The [International Society of Arboriculture](https://www.treesaregood.org/treeowner/pruneyourtrees) includes removing rootstock sprouts as part of routine tree care, and we agree completely.
...
If your tree is suckering heavily *and* showing any of these other symptoms, don't ignore it. A stressed tree that's also producing heavy sucker growth may be in serious decline. In some cases, that tree becomes a safety concern, especially during Boise's winter windstorms. Our [emergency tree service](https://boisetreepro.com/services/emergency-tree-service-boise/) handles trees that have become hazards, but ideally you catch the warning signs early.
...
**What to do:** This usually means cottonwoods, aspens, or another aggressive suckering species. Your options are ongoing removal (a real commitment), root barriers to contain spread, or [tree removal](https://boisetreepro.com/services/tree-removal-boise/) if the problem is severe enough. Be honest about how much maintenance you're willing to do.
...
For light suckering, they can reduce your maintenance burden. For heavy suckering caused by tree stress, they're not going to solve the problem. According to the [USDA Forest Service](https://www.fs.usda.gov/), managing the overall health of the tree is far more effective than topical growth inhibitors for long-term sucker control.
...
At Boise Tree Pros, we've been helping Treasure Valley homeowners deal with problem trees for over 15 years. A proper assessment looks at the whole picture: the tree's health, the root system, the species, the site conditions. That gives you a plan that addresses the cause, not just the symptoms. [Get in touch for a free assessment.](https://boisetreepro.com/#contact)
