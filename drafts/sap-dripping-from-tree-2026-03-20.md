...
If your tree took a hit during one of Boise's late-spring windstorms and is now leaking sap from significant wounds, our [emergency tree service](https://boisetreepro.com/services/emergency-tree-service-boise/) team can assess whether the tree is structurally sound or if those wounds create a failure risk.
...
- **Elm trees:** Scale insects love them. The [University of Idaho Extension](https://www.uidaho.edu/extension/county/ada) has documented recurring elm scale issues throughout Ada County.
...
Maria's tree wasn't dying. It had tenants. A targeted treatment and a follow-up [tree trimming](https://boisetreepro.com/services/tree-trimming-boise/) to remove the most heavily infested interior branches knocked the problem down by 90% within three weeks.
...
**Concerned about tree sap on car surfaces or honeydew damage to your property?** We offer free tree health assessments throughout the Boise area. [Get in touch with our team](https://boisetreepro.com/#contact). We'll identify exactly what's dripping and give you a straight answer on what to do about it.
...
Here's the nuanced answer: **wetwood itself rarely kills a tree**, but it signals internal decay that can compromise structural integrity over time. The [International Society of Arboriculture (ISA)](https://www.treesaregood.org/) notes that wetwood-affected trees should be monitored for structural soundness, especially large specimens near homes or driveways.
...
We performed a targeted [tree trimming](https://boisetreepro.com/services/tree-trimming-boise/) to remove the compromised branch and reduce the canopy weight on that side. Dave's tree is still standing and healthy four years later. But if he'd ignored it another season or two, that branch could have failed during a Boise windstorm.

### What NOT to Do

Old advice said to drill drainage holes in wetwood-affected trees or apply wound dressings. **Don't do either.** Drilling creates new entry points for decay fungi, and wound dressings have been shown by [USDA Forest Service research](https://www.fs.usda.gov/) to slow natural wound closure rather than help it.
...
| Feature | Real Sap | Honeydew (Insects) | Slime Flux |
|---|---|---|---|
| **Color** | Clear to amber | Clear, darkens with sooty mold | Dark brown to black |
| **Smell** | Mild, sweet | Odorless to faintly sweet | Sour, fermented |
| **Source** | Bark, wounds, cuts | Falls from canopy (leaves) | Oozes from trunk |
| **Texture** | Sticky, may harden | Sticky, stays liquid | Thin, watery |
| **Sooty mold?** | No | Yes (black patches) | No |
| **Insects visible?** | No | Yes (check leaf undersides) | No |
| **Concern level** | Usually low | Moderate; treat the pests | Monitor structure |
...
- **Prune heavily infested branches.** Removing dense interior growth improves air circulation and reduces habitat for pest colonies. Our [tree trimming service](https://boisetreepro.com/services/tree-trimming-boise/) includes a pest assessment with every visit.
...
- **Consider removal** only if decay has significantly compromised the trunk or major scaffold branches. Our team can help you evaluate whether [tree removal](https://boisetreepro.com/services/tree-removal-boise/) is warranted or if the tree can be preserved with targeted pruning.
...
**[Schedule your free tree health assessment](https://boisetreepro.com/#contact)** and we'll get to the bottom of what's dripping and whether it matters.
