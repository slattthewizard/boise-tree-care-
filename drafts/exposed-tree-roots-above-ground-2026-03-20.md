---
Meta Title: Tree Roots Above Ground: What to Do | Boise Tree Pros
Meta Description: Wondering what to do about tree roots above ground? Learn safe fixes that protect your tree, the #1 mistake to avoid, and when to call an arborist in Boise.
Primary Keyword: tree roots above ground what to do
Secondary Keywords: exposed tree roots, tree roots sticking up, how to cover tree roots in yard, surface tree roots
URL Slug: /blog/exposed-tree-roots-what-to-do
Internal Links: /services/tree-removal-boise/, /services/tree-trimming-boise/, /#services, /#contact
External Links: ISA (isa-arbor.com), University of Idaho Extension (uidaho.edu)
Word Count: ~2,600
---
...
If your tree roots are sticking up and you want to understand the full picture of what's happening underground, [a tree health assessment](https://boisetreepro.com/#services) is a smart starting point.
...
**Spread two to three inches of organic mulch** (wood chips, shredded bark, or arborist chips) over the exposed roots. Keep the mulch a few inches away from the trunk itself (no [volcano mulching](https://boisetreepro.com/services/tree-trimming-boise/)). Extend it out to the drip line if possible.
...
Cutting a tree root is essentially amputating part of the tree's support and nutrient system. According to [ISA best management practices](https://www.isa-arbor.com/), root pruning should only be considered when:
...
We had a situation in the Bench area where a homeowner, Tom, cut three large roots on the south side of a cottonwood because they were lifting his fence. The tree survived, but it developed a noticeable lean toward the south within two years. We ended up recommending removal because the tree had become a [safety risk](https://boisetreepro.com/services/tree-removal-boise/) over his neighbor's property.

**If you're dealing with surface tree roots near structures**, [give us a call](https://boisetreepro.com/#contact) before you grab the chainsaw. A quick assessment can save you from a much bigger problem down the road.
...
If you notice any of these signs, **don't wait.** A tree with compromised roots can fail without warning. [Contact us for a root and stability assessment](https://boisetreepro.com/#contact), especially if the tree is near your home, driveway, or a neighbor's property.
...
The [University of Idaho Extension](https://www.uidaho.edu/extension/county/ada) has excellent resources on proper watering for Treasure Valley landscapes if you want to learn more.
...
**Roots are barely visible, just catching the mower:**
Raise your mower height. Add one to two inches of topsoil. Monitor annually.

**Roots cover a moderate area, causing tripping hazards:**
Apply two to three inches of mulch. Create a defined mulch ring or bed. This solves 80% of cases.

**Roots cover a large area, grass won't grow:**
...
Call a certified arborist. Selective root pruning *may* be possible, but it needs professional evaluation. Sometimes [strategic trimming](https://boisetreepro.com/services/tree-trimming-boise/) to reduce canopy weight can help slow root expansion.
...
If you're unsure about the best approach for your specific tree, or if those exposed roots are making you nervous about stability, **we're happy to take a look.** A quick on-site assessment gives you a clear plan and peace of mind. [Reach out to Boise Tree Pros](https://boisetreepro.com/#contact) and we'll help you figure out the right move.
