---
Meta Title: How Deep Do Tree Roots Go? Boise Root Depth Guide
Meta Description: Most tree roots stay in the top 12-18 inches. Learn about root depth, sewer line damage, sidewalk problems, and invasive roots in Boise yards.
Primary Keyword: how deep do tree roots go
Secondary Keywords: tree roots sewer line, tree root depth, tree roots sidewalk damage, how far do tree roots spread
URL Slug: /blog/how-deep-do-tree-roots-go
Internal Links: tree removal, tree trimming, services overview, contact
External Links: ISA, University of Idaho Extension, USDA Forest Service
Word Count: ~2,800
---
...
According to the [International Society of Arboriculture (ISA)](https://www.treesaregood.org/), roughly 80-90% of a tree's absorbing roots occupy the upper foot and a half of soil. That's where the oxygen, water, and nutrients are. Roots follow resources, not gravity.
...
Wondering whether a tree in your yard needs professional attention? [Our arborists can assess root and tree health on-site](https://boisetreepro.com/#services) with a free estimate.
...
Want help choosing the right tree for your property? [Boise Tree Pros offers tree consultation and education](https://boisetreepro.com/#services) so you plant smart from the start.
...
If roots have already invaded your sewer line, the tree might need to come down. [Our tree removal team](https://boisetreepro.com/services/tree-removal-boise/) can assess the situation and give you a straight answer about whether removal is the right call.
...
**Need a root assessment?** [Contact Boise Tree Pros](https://boisetreepro.com/#contact) for a professional evaluation before cutting any roots.
...
Consider a homeowner who spends $300 per year on sewer line clearing, plus $1,500 every few years on sidewalk repairs. Over a decade, that's $6,000 or more in root-related maintenance. Professional [tree removal in Boise](https://boisetreepro.com/services/tree-removal-boise/) costs less than that, and it solves the problem permanently.
...
- Schedule regular [tree trimming and pruning](https://boisetreepro.com/services/tree-trimming-boise/) -- a healthy, well-maintained tree is less likely to develop problem root patterns
...
- Document damage for insurance purposes (our team provides [professional tree reports](https://boisetreepro.com/#services) if needed)

## FAQs: Tree Root Depth and Damage

**How deep do tree roots actually go?**
Most tree roots grow in the top 12 to 18 inches of soil. Some structural roots may reach 3 to 6 feet deep, and in rare cases a tap root can go deeper, but 80-90% of the root system stays shallow.

**Can tree roots damage my foundation?**
Yes, though it's less common than sewer or sidewalk damage. Roots typically exploit existing cracks rather than breaking through intact concrete. Older foundations with cracks or poor drainage are most vulnerable.

**How far do tree roots spread from the trunk?**
Roots commonly extend two to three times the tree's height. A 30-foot tree may have roots reaching 60-90 feet from the trunk in all directions.

**Will cutting tree roots kill the tree?**
It depends on which roots, how many, and how close to the trunk. Cutting small roots on one side usually won't kill a healthy tree. Cutting large structural roots or roots on multiple sides can destabilize or kill it.

**Do root barriers actually work?**
Root barriers can redirect root growth and are effective when installed correctly. They're not a permanent guarantee, but they significantly reduce root intrusion toward pipes and concrete.

**Should I remove a tree that's damaging my sewer line?**
Not always, but if roots have invaded the pipe more than once, removal is usually the most cost-effective long-term solution. A professional assessment will tell you whether the tree can stay with management or whether it needs to go.
...
**Call (208) 555-0192 for a free estimate**, or [schedule your visit online](https://boisetreepro.com/#contact). We serve Boise, Meridian, Eagle, Nampa, and the greater Treasure Valley.
